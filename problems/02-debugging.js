...
function incrementCounter1(counter1) { //okay so this sets a function that takes in a counter arguement
  counter1 += 1; //we've added one to the argument
  console.log(counter1); //and now we've logged that argument. honestly it is printing NaN cus when you call a function THAT'S when you pass the argument
}

console.log(incrementCounter1()); //the problem is the argument needs to be called here, not just a regular variable
